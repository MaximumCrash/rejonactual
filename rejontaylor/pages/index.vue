...
<section class="container">
    ...
    <div class="section project project0" data-anchor="works">
      <a class="content" href="/works/0" >
        <div class="project-title">
          <h1 class="layer0">Becker Derby</h1>
          <h1 class="layer1">Becker Derby</h1>
          <h1 class="layer2">Becker Derby</h1>
          <h1 class="layer3">Becker Derby</h1>
          <h1 class="layer4">Becker Derby</h1>
          <h1 class="layer5">Becker Derby</h1>
        </div>
        <div class="project-blurb">
          An endless homerun derby to go, featuring Becker College's Hank the Hawk.
        </div>
        ...
        <div class="picture">
          ...
          <div class="image">
            <img src="~/assets/Images/beckerDerby_header.jpg"/>
          </div>
          
        </div>
      </a>
    </div>
    <div class="section project project1" data-anchor="works-2">
      <a class="content" :href="'/works/1'">
        <div class="project-title">
          <h1 class="layer0">Dailybreak.com</h1>
          <h1 class="layer1">Dailybreak.com</h1>
          <h1 class="layer2">Dailybreak.com</h1>
          <h1 class="layer3">Dailybreak.com</h1>
          <h1 class="layer4">Dailybreak.com</h1>
          <h1 class="layer5">Dailybreak.com</h1>
        </div>
        <div class="project-blurb">
          A content website that rewards you for procrastinating. 
        </div>
        <div class="project-link">
          <span class="link-text">View Project</span>
          <span class="link-bullet"></span>
        ...
        <div class="picture">
          ...
          <div class="image">
            <img src="~/assets/Images/dailybreak_header.jpg"/>
          </div>
          
        </div>
      </a>
    </div>
    <div class="section project project2" data-anchor="works-3">
      <a class="content" href="/works/3" >
        <div class="project-title">
          <h1 class="layer0">Hibachi Hero</h1>
          <h1 class="layer1">Hibachi Hero</h1>
          <h1 class="layer2">Hibachi Hero</h1>
          <h1 class="layer3">Hibachi Hero</h1>
          <h1 class="layer4">Hibachi Hero</h1>
          <h1 class="layer5">Hibachi Hero</h1>
        </div>
        <div class="project-blurb">
          A fast-paced first person food shooter that helps it's players manage their emotions.
        </div>
        <div class="project-link">
          <span class="link-text">View Project</span>
          <span class="link-bullet"></span>
        ...
        <div class="picture">
          ...
          <div class="image">
            <img src="~/assets/Images/hibachiHero_header.jpg"/>
          </div>
          
        </div>
      </a>
    </div>
    <div class="section project project3" data-anchor="works-4">
      <a class="content" href="/works/4">
        <div class="project-title">
          <h1 class="layer0">Lotto' Boxes</h1>
          <h1 class="layer1">Lotto' Boxes</h1>
          <h1 class="layer2">Lotto' Boxes</h1>
          <h1 class="layer3">Lotto' Boxes</h1>
          <h1 class="layer4">Lotto' Boxes</h1>
          <h1 class="layer5">Lotto' Boxes</h1>
        </div>
        <div class="project-blurb">
          An educational mobile game spotlighting Income Inequality in America.
        </div>
        <div class="project-link">
          <span class="link-text">View Project</span>
          <span class="link-bullet"></span>
        ...
        <div class="picture">
          ...
          <div class="image">
            <img src="~/assets/Images/lottoBoxes_header.png"/>
          </div>
...
const apiUrl =
  process.env.API_URL ||
  'https://glacial-brushlands-60262.herokuapp.com' ||
  'localhost:1337'
...
export default {
  data() {
    return {
      options: {
        ...
        licenseKey:
          process.env.FP_LICENSE_KEY || '4A6E5C2A-3C2D488B-95692C91-0D280E52',
  ...
  methods: {
    ...
    onLeaveSection(origin, destination, direction) {
      if (destination.index === 0) {
        this.ctaTimeout = setTimeout(function() {
          if (
            document.querySelector('.scroll-cta').classList.contains('show')
          ) {
      ...
      if (origin.index === 0) {
        ...
        if (!this.isShowingHeader && this.headerAnime !== null) {
          document.querySelector('#fp-nav').classList.add('show');
  ...
  mounted() {
    ...
    let lastNameWrapper = this.$el.querySelector('.title h2')
    charming(lastNameWrapper)
    lastNameWrapper.style.opacity = 1
    let secondTarget = lastNameWrapper.querySelectorAll('span')

    let subTitle = this.$el.querySelector('.sub-title p')

    let heroLinks = this.$el.querySelectorAll('.hero-links li')

    var scrollCTA = this.$el.querySelector('.scroll-cta');
    ...
    const profileBackText = this.$el.querySelector(
      '.about .profilepic-parallax-container .profilepic-text-parallax .profile-backText'
    )
    charming(profileBackText)
    let profileBackChars = profileBackText.querySelectorAll('span')
    profileBackText.style.opacity = 1

    const profileFrontText = this.$el.querySelector(
      '.about .profilepic-parallax-container .profilepic-text-parallax .profile-frontText'
    )
    charming(profileFrontText)
    let profileFrontChars = profileFrontText.querySelectorAll('span')
    profileFrontText.style.opacity = 1

    const profilePic = this.$el.querySelector(
      '.about .profilepic-parallax-container .profilepic-parallax img'
    )
    const profileBG = this.$el.querySelector(
      '.about .profilepic-parallax-container .profilebg-parallax .bg'
    )
    ...
    const contactFrontText = this.$el.querySelector(
      '.contact .profile-frontText'
    )
    charming(contactFrontText)
    let contactFrontChars = contactFrontText.querySelectorAll('span')
    contactFrontText.style.opacity = 1

    const contactPic = this.$el.querySelector(
      '.contact .profilepic-parallax img'
    )
    ...
    this.pageAnime[6]
      ...
      const dotLayer0 = document.querySelector('.dot-layer-0');
...
.project .project-link:hover .link-text {
  ...
  transition: all 0.164s ease-in-out;
}
...
.project .content .project-blurb {
  ...
  max-width: 723px;
  pointer-events: none;
  text-shadow: 0 6px 9px rgba(11, 11, 61, 1), -1px 0 rgba(11, 11, 61, 0.64),
    0 1px rgba(11, 11, 61, 0.64), 1px 0 rgba(11, 11, 61, 0.64),
    0 -1px rgba(11, 11, 61, 0.64);
}
...
.project .content .picture .overlay {
      position: absolute;
    width: 100%;
    height: 100%;
    z-index: 10000;
